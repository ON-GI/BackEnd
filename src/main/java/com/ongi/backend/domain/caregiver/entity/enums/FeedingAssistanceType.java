...
public enum FeedingAssistanceType {
    ...
    public static FeedingAssistanceType fromString(String value) {
        return Arrays.stream(FeedingAssistanceType.values())
                .filter(type -> type.name().equals(value))
                .findFirst()
                .orElseThrow(() -> new ApplicationException(CaregiverErrorCase.INVALID_FEEDING_ASSISTANCE));
    }
}
