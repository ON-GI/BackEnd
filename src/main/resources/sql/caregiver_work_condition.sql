...
VALUES
    (47, 'HOURLY', 14000, true),
    (48, 'HOURLY', 15000, false),
    (49, 'HOURLY', 13000, true),
    (50, 'HOURLY', 14500, false),
    (51, 'HOURLY', 15500, true),
    (52, 'HOURLY', 14000, true),
    (53, 'HOURLY', 13500, false),
    (54, 'HOURLY', 14000, false),
    (55, 'HOURLY', 14500, true),
    (56, 'HOURLY', 13800, true),
    (57, 'HOURLY', 14200, true),
    (58, 'HOURLY', 14800, false),
    (59, 'HOURLY', 13200, true),
    (60, 'HOURLY', 14700, false),
    (61, 'HOURLY', 15600, true),
    (62, 'HOURLY', 13900, true),
    (63, 'HOURLY', 13400, false),
    (64, 'HOURLY', 14100, false),
    (65, 'HOURLY', 14400, true),
    (66, 'HOURLY', 13700, true),
    (67, 'HOURLY', 14300, true),
    (68, 'HOURLY', 14900, false),
    (69, 'HOURLY', 13100, true),
    (70, 'HOURLY', 14600, false),
    (71, 'HOURLY', 15400, true),
    (72, 'HOURLY', 13900, true),
    (73, 'HOURLY', 13300, false),
    (74, 'HOURLY', 14000, false),
    (75, 'HOURLY', 14300, true),
    (76, 'HOURLY', 13500, true);
...
VALUES
    ...
    (31, 'WEDNESDAY', '08:00:00', '12:00:00');
